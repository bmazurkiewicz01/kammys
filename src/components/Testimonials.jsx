              ...
              <div
                ...
                style={{
                  background: isDarkMode
                    ? "linear-gradient(90deg, rgb(25, 118, 210) -0.55%, rgb(22, 104, 186) 22.86%, rgb(19, 90, 162) 48.36%, rgb(16, 76, 138) 73.33%, rgb(13, 62, 114) 99.34%)"
                    : "linear-gradient(90deg, rgb(180, 213, 249) -0.55%, rgb(144, 194, 243) 22.86%, rgb(108, 175, 238) 48.36%, rgb(72, 156, 233) 73.33%, rgb(36, 137, 227) 99.34%)",
                }}
              ></div>
            </div>
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 dark:text-[#AAAAAA] font-pj">
                        “Jestem bardzo zadowolona z usług firmy. Chłopaki znają
                        się na swojej robocie, przeprowadzka przeszła bardzo
                        szybko i sprawnie. Meble sami zabezpieczali przed
                        uszkodzeniem. Uczynni i sympatyczni panowie. Cena
                        również przystępna!”
                      </p>
                    </blockquote>
                  </div>
              ...
              <div className="flex flex-col overflow-hidden">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white dark:bg-[rgba(8,15,16,0.9)] border-[1px] border-[rgb(156,204,252)] dark:border-[rgb(2,41,79)] rounded-3xl lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 dark:text-[#AAAAAA]  font-pj">
                        “W pełni zasłużona, bardzo pozytywna opinia. Pianino, co
                        do którego były obawy, że nie będzie możliwości
                        wyniesienia go z miejsca w którym stało (pierwsze
                        piętro, ciasna klatka schodowa), Panowie
                        przetransportowali na miejsce docelowe.”
                      </p>
                    </blockquote>
                  </div>
                  <div className="flex items-center mt-8">
              ...
              <div className="flex flex-col overflow-hidden">
                <div className="flex flex-col justify-between flex-1 p-6 bg-white dark:bg-[rgba(8,15,16,0.9)] border-[1px] border-[rgb(156,204,252)] dark:border-[rgb(2,41,79)] rounded-3xl lg:py-8 lg:px-7">
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 dark:text-[#AAAAAA] font-pj">
                        “Pełen profesjonalizm. Panowie wykazują się niesamowitą
                        punktualnością, sprawnością i pomysłowością. Zawsze
                        wszystko starannie przewiezione bez najmniejszych
                        uszkodzeń 💪🏾”
                      </p>
                    </blockquote>
                  </div>
