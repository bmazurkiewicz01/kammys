...
const ThemeButton: React.FC<ThemeButtonProps> = ({ classList }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          className="absolute w-[20px] top-[5px] left-[5px] fill-white transition duration-300 sun"
          src={Sun.src}
          alt="Sun icon"
          width={20}
          height={20}
        />
        <Image
          className="absolute w-[20px] top-[5px] left-[40px] fill-[#7e7e7e] transition duration-300 moon"
          src={Moon.src}
          alt="Moon icon"
          width={20}
          height={20}
